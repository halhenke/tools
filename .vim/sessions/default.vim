...
" Created by session.vim 1.5 on 26 August 2012 at 01:41:32.
...
badd +0 ~/Code/ShellScripting/setupMacPortsWithMySymlinks.sh
silent! argdel *
...
normal! 0
lcd ~/Code/Ruby/Rails/blog
tabedit ~/Code/Ruby/Rails/blog/NERD_tree_2
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 73 - ((29 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
tabedit ~/Code/ShellScripting/setupMacPortsWithMySymlinks.sh
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
